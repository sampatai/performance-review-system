...
namespace OfficePerformanceReview.Infrastructure.Migrations
{
    ...
    [Migration("20250602003949_added_new_field_addRemarks")]
    partial class added_new_field_addRemarks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OfficeReview.Domain.Questions.Entities.Question", b =>
                {
                    ...
                    b.OwnsMany("OfficePerformanceReview.Domain.Questions.ValueObjects.QuestionOption", "Options", b1 =>
                        {
                            b1.Property<long>("QuestionId")
                                .HasColumnType("bigint");
